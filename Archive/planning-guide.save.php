...
function selectRecord($S) {
  ...
  $query = "select clubname, officeyear, presidentname from test " .
...
function copyRecord($S) {
  ...
  $query = "select page2, page3, page4, page5, page6, page7 from test ".
  ...
  $query = "insert into test (clubname, officeyear, presidentname, address, phone, email, page2, page3, page4, page5, page6, page7) ".
...
function page2($S) {
  ...
  $query = "select page2 from test where clubname='$clubname' and officeyear='$officeyear' and presidentname='$presidentname'";

  list($result, $n) = $S->query($query, true);

  if($n) {
    list($page2) = mysql_fetch_row($result);
    ...
    // insert new entry
    $query = "insert into test (clubname, officeyear, presidentname, address, phone, email) ".
             "values('$clubname', '$officeyear', '$presidentname', '$address', '$phone', '$email')";
    //echo "$query<br>";
    $S->query($query);
  } 
...
function page3($S) {
  ...
  $query = "update test set page2='$s' " .
           "where clubname='{$_POST['clubname']}' and officeyear='{$_POST['officeyear']}' ".
           "and presidentname='{$_POST['presidentname']}'";

  $S->query($query);

  $query = "select page3 from test where clubname='$clubname' and officeyear='$officeyear' and presidentname='$presidentname'";

  list($result, $n) = $S->query($query, true);

  if($n) {
    list($page3) = mysql_fetch_row($result);
    if($page3) {
...
function page4($S) {
  ...
  $s = serialize($ar);
  $s = mysql_real_escape_string($s);
  $query = "update test set page3='$s' " .
           "where clubname='{$_POST['clubname']}' and officeyear='{$_POST['officeyear']}' ".
           "and presidentname='{$_POST['presidentname']}'";

  $S->query($query);

  $query = "select page4 from test where clubname='$clubname' and officeyear='$officeyear' and presidentname='$presidentname'";

  list($result, $n) = $S->query($query, true);

  if($n) {
    list($page4) = mysql_fetch_row($result);
    if($page4) {
...
<li>Request Society members: <input type="text" name="p4_25" value="$p4_25"/></li>
</ul>
...
Other (please describe)<br>
<textarea anem="p4_43">$p4_43</textarea><br>
<br>
<input type="submit" value="Continue"/>
...
function page5($S) {
  ...
  $s = serialize($ar);
  $s = mysql_real_escape_string($s);
  $query = "update test set page4='$s' " .
           "where clubname='{$_POST['clubname']}' and officeyear='{$_POST['officeyear']}' ".
           "and presidentname='{$_POST['presidentname']}'";

  $S->query($query);

  $query = "select page5 from test where clubname='$clubname' and officeyear='$officeyear' and presidentname='$presidentname'";

  list($result, $n) = $S->query($query, true);

  if($n) {
    list($page5) = mysql_fetch_row($result);
    if($page5) {
...
<textarea anem="p5_8">$p5_8</textarea><br>
<br>
...
function page6($S) {
  ...
  $s = serialize($ar);
  $s = mysql_real_escape_string($s);
  $query = "update test set page5='$s' " .
           "where clubname='{$_POST['clubname']}' and officeyear='{$_POST['officeyear']}' ".
           "and presidentname='{$_POST['presidentname']}'";

  $S->query($query);

  $query = "select page6 from test where clubname='$clubname' and officeyear='$officeyear' and presidentname='$presidentname'";

  list($result, $n) = $S->query($query, true);

  if($n) {
    list($page6) = mysql_fetch_row($result);
    if($page6) {
...
<textarea anem="p6_2">$p6_2</textarea><br>
<br>
How does the club plan to achieve its public relation goals? (check all the apply))<br>
<input type="checkbox" name="p6_c3" $p6_c3/> Ensure the public relations committee is trained in conducting a multimedia campagn<br>
...
Other (please describe)<br>
<textarea anem="p6_7">$p6_7</textarea><br>
<br>
...
<textarea anem="p6_18">$p6_18</textarea><br>
<br>
...
<textarea anem="p6_23">$p6_23</textarea><br>
<br>
...
<textarea anem="p6_45">$p6_45</textarea><br>
<br>
Other (please describe><br>
<textarea anem="p6_46">$p6_45</textarea><br>
<br>
Our club would like assistance from the governor or assistant governor with the following:<br>
<textarea anem="p6_47">$p6_47</textarea><br>
<br>
Our club would like to discuss the following issures with the governor or assistant governor during a visit to ouor club:<br>
<textarea anem="p6_48">$p6_48</textarea><br>
<br>
<input type="submit" value="Continue"/>
...
function page7($S) {
  ...
  $s = serialize($ar);
  $s = mysql_real_escape_string($s);
  $query = "update test set page6='$s' " .
           "where clubname='{$_POST['clubname']}' and officeyear='{$_POST['officeyear']}' ".
           "and presidentname='{$_POST['presidentname']}'";

  $S->query($query);

  $query = "select page7 from test where clubname='$clubname' and officeyear='$officeyear' and presidentname='$presidentname'";

  list($result, $n) = $S->query($query, true);

  if($n) {
    list($page7) = mysql_fetch_row($result);
    if($page7) {
...
$S->top
<form action="$S->self" method="post">
Summary of goals for the our Rotary Club:<br>
...
<script type="text/javascript">
jQuery(document).ready(function($) {
  $("textarea").css({'width': '800px', 'height': '100px', 'background-color':'white', 'color':'black'});
  $("textarea").attr('disabled', 'disabled');
  $("input").attr('disabled', 'disabled');
  $("input[type='checkbox']").removeAttr('disabled');
  $("input[type=radio][checked]").wrap('<span style="border: 5px solid black"/>');
...
EOF;
  ...
  $query = "select clubname, officeyear, presidentname, address, phone, email, page2, page3, page4, page5, page6, page7 from test ".
...
Rotary Club of <input type="text" value="$clubname" /><br>
Rotary Year of office (the year your term started): <input type="text" value="$officeyear" /><br>
Name of President: <input type="text" value="$presidentname" /><br>
Mailing Address: <input type="text" value="$address" /><br>
Phone: <input type="text" value="$phone" /><br>
...
<hr>
<h3>Summary of goals for the our Rotary Club</h3>
Membership Goal: <input type=text name"p7_1"/> members by end of term<br>
Service goals:<br>
<ul>
<li>For our community:<br>
