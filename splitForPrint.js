...
$(window).load(function() {
   ...
   * tableIndex - and index from original page where this table is
   * sitting, allows to properly insert table back to where it belonged 
   * onTableSplittedCallback - a function that will be called when
   * table will be splitted out - allows to do some post-processing if required 
   */
